function [ZC_curve] = ZC_bootstrap_IRS_only(market_data)
% Bootstrap method to derive the curve of the discount factors
% take a matrix containing date and rate for only swaps,
% starting from those data the function computes the discount factor  
%
% INPUT:
